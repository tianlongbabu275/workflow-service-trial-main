...
// Source: vendor/go.temporal.io/sdk/client/client.go

// command: mockgen -package temporal -source vendor/go.temporal.io/sdk/client/client.go -destination shared/temporal/client_mock.go
package temporal
